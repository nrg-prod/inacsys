...
import com.inacsys.managedBean.PurchaseViewMB;
...
public interface DemoController {
	...
	public ArrayList<I0015> purchaseOrderClose(ArrayList<I0015> purchaselist1,
			PurchaseOrder purchaseOrder) throws DemoException;
	...
	//public List<SalesOrderFormMB> getQuoteview(List<SalesOrderFormMB> quoteList); 
	...
	public String paymentSave(Buyer b);

	public List<Buyer> getmemberPayment(Buyer b);

	public String mamberPaymentUpdate(Buyer b);

	public String mamberPaymentDelete(Buyer b);

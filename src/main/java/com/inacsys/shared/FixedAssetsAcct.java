...
/**
 * The persistent class for the fixed_assets_acct database table.
 * 
 */
@Entity
@Table(name="fixed_assets_acct")
@NamedQuery(name="FixedAssetsAcct.findAll", query="SELECT f FROM FixedAssetsAcct f")
public class FixedAssetsAcct implements Serializable {
	...
	public FixedAssetsAcct() {
	}

	public FixedAssetsAcct(AccountsDatabean accountsDatabean, ChartOfAccount chartOfAccount) {
	...
	public FixedAssetsAcct(ATransaction atrans, ATransaction aTransaction,String categoryType,String detailType, ExpenseTransaction expenseTransaction) {
	...
	public FixedAssetsAcct(String categoryType,String detailType, ATransaction aTransaction,ATransaction atrans, ExpenseTransaction expenseTransaction) {
	...
	public FixedAssetsAcct(AccountsDatabean accountsDatabean,List<ChartOfAccount> accDeposit) {

...
/**
 * The persistent class for the other_assets_acct database table.
 * 
 */
@Entity
@Table(name="other_assets_acct")
@NamedQuery(name="OtherAssetsAcct.findAll", query="SELECT o FROM OtherAssetsAcct o")
public class OtherAssetsAcct implements Serializable {
	...
	public OtherAssetsAcct() {
	}

	public OtherAssetsAcct(AccountsDatabean accountsDatabean, ChartOfAccount chartOfAccount) {
	...
	public OtherAssetsAcct(ATransaction atrans, ATransaction aTransaction,String categoryType,String detailType, ExpenseTransaction expenseTransaction) {
	...
	public OtherAssetsAcct(String categoryType,String detailType, ATransaction aTransaction,ATransaction atrans, ExpenseTransaction expenseTransaction) {
	...
	public OtherAssetsAcct(AccountsDatabean accountsDatabean,List<ChartOfAccount> accDeposit) {

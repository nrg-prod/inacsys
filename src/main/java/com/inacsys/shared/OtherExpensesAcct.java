...
/**
 * The persistent class for the other_expenses_acct database table.
 * 
 */
@Entity
@Table(name="other_expenses_acct")
@NamedQuery(name="OtherExpensesAcct.findAll", query="SELECT o FROM OtherExpensesAcct o")
public class OtherExpensesAcct implements Serializable {
	...
	public OtherExpensesAcct() {
	}
	
	public OtherExpensesAcct(ATransaction atrans, ATransaction aTransaction,String categoryType,String detailType, ExpenseTransaction expenseTransaction) {
	...
	public OtherExpensesAcct(String categoryType,String detailType, ATransaction aTransaction,ATransaction atrans, ExpenseTransaction expenseTransaction) {
		this.tranDate=aTransaction.getBillDate();
		this.createdDate=new Date();
		this.invoiceNumber=aTransaction.getRefNo();
		this.accountName=atrans.getToAccount();

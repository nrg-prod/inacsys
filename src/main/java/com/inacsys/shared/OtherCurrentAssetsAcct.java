...
/**
 * The persistent class for the other_current_assets_acct database table.
 * 
 */
@Entity
@Table(name="other_current_assets_acct")
@NamedQuery(name="OtherCurrentAssetsAcct.findAll", query="SELECT o FROM OtherCurrentAssetsAcct o")
public class OtherCurrentAssetsAcct implements Serializable {
	...
	public OtherCurrentAssetsAcct() {
	}

	public OtherCurrentAssetsAcct(AccountsDatabean accountsDatabean, ChartOfAccount chartOfAccount) {
	...
	public OtherCurrentAssetsAcct(String clientID, ATransaction aTransaction,String categoryType,String detailType) {
	...
	public OtherCurrentAssetsAcct(String clientID, ATransaction aTransaction,String categoryType,String detailType, SalesTransaction salestrans) {
		this.tranDate=aTransaction.getBillDate();
		this.createdDate=new Date();
		this.invoiceNumber=aTransaction.getTransactionNo();
		this.accountName=aTransaction.getAccountType();
	...
	public OtherCurrentAssetsAcct(ATransaction atrans,ATransaction aTransaction, String categoryType,String detailType,ExpenseTransaction expenseTransaction) {
		this.tranDate=aTransaction.getBillDate();
		this.createdDate=new Date();
	...
	public OtherCurrentAssetsAcct(String categoryType,String detailType, ATransaction aTransaction,ATransaction atrans, ExpenseTransaction expenseTransaction) {
	...
	public OtherCurrentAssetsAcct(AccountsDatabean accountsDatabean,List<ChartOfAccount> accDeposit) {

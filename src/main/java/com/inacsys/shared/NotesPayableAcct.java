...
/**
 * The persistent class for the notes_payable_acct database table.
 * 
 */
@Entity
@Table(name="notes_payable_acct")
@NamedQuery(name="NotesPayableAcct.findAll", query="SELECT n FROM NotesPayableAcct n")
public class NotesPayableAcct implements Serializable {
	...
	public NotesPayableAcct() {
	}

	public NotesPayableAcct(AccountsDatabean accountsDatabean,ChartOfAccount chartofaccount) {
	...
	public NotesPayableAcct(ATransaction atrans, ATransaction aTransaction,String categoryType,String detailType, ExpenseTransaction expenseTransaction) {
	...
	public NotesPayableAcct(String categoryType,String detailType, ATransaction atrans,ATransaction aTransaction, ExpenseTransaction expenseTransaction) {
		this.tranDate=aTransaction.getBillDate();
		this.createdDate=new Date();
		this.invoiceNumber=aTransaction.getRefNo();
		this.accountName=atrans.getToAccount();
	...
	public NotesPayableAcct(AccountsDatabean accountsDatabean,List<ChartOfAccount> accDeposit) {

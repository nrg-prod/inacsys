...
/**
 * The persistent class for the equity_acct database table.
 * 
 */
@Entity
@Table(name="equity_acct")
@NamedQuery(name="EquityAcct.findAll", query="SELECT e FROM EquityAcct e")
public class EquityAcct implements Serializable {
	...
	public EquityAcct(AccountsDatabean accountsDatabean,ChartOfAccount chartofaccount) {
	...
	public EquityAcct(ATransaction atrans, ATransaction aTransaction,String categoryType,String detailType, ExpenseTransaction expenseTransaction) {
	...
	public EquityAcct(String categoryType,String detailType, ATransaction atrans,ATransaction aTransaction, ExpenseTransaction expenseTransaction) {
		this.tranDate=aTransaction.getBillDate();
		this.createdDate=new Date();
		this.invoiceNumber=aTransaction.getRefNo();
		this.accountName=atrans.getToAccount();
	...
	public EquityAcct(AccountsDatabean accountsDatabean,List<ChartOfAccount> accDeposit) {

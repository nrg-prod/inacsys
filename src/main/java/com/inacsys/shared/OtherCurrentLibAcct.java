...
/**
 * The persistent class for the other_current_lib_acct database table.
 * 
 */
@Entity
@Table(name="other_current_lib_acct")
@NamedQuery(name="OtherCurrentLibAcct.findAll", query="SELECT o FROM OtherCurrentLibAcct o")
public class OtherCurrentLibAcct implements Serializable {
	...
	public OtherCurrentLibAcct() {
	}

	public OtherCurrentLibAcct(AccountsDatabean accountsDatabean,ChartOfAccount chartofaccount) {
	...
	public OtherCurrentLibAcct(ATransaction atrans, ATransaction aTransaction,String categoryType,String detailType, ExpenseTransaction expenseTransaction) {
	...
	public OtherCurrentLibAcct(String categoryType,String detailType, ATransaction atrans,ATransaction aTransaction, ExpenseTransaction expenseTransaction) {
		this.tranDate=aTransaction.getBillDate();
		this.createdDate=new Date();
		this.invoiceNumber=aTransaction.getRefNo();
		this.accountName=atrans.getToAccount();
	...
	public OtherCurrentLibAcct(AccountsDatabean accountsDatabean,List<ChartOfAccount> accDeposit) {
		this.tranDate=new Date();
		this.createdDate=new Date();
		this.accountName=accountsDatabean.getAccount_name();
		this.transactionType=accountsDatabean.getTransactionType();

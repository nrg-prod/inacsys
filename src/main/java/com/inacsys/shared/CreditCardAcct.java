 ...
 */
@Entity
@Table(name="credit_card_acct")
@NamedQuery(name="CreditCardAcct.findAll", query="SELECT c FROM CreditCardAcct c")
public class CreditCardAcct implements Serializable {
	...
	public CreditCardAcct() {
	}

	public CreditCardAcct(AccountsDatabean accountsDatabean,ChartOfAccount chartOfAccount) {
	...
	public CreditCardAcct(ATransaction atrans, ATransaction aTransaction,String categoryType,String detailType, ExpenseTransaction expenseTransaction) {
	...
	public CreditCardAcct(String clientID, ATransaction aTransaction,String categoryType,String detailType, ExpenseTransaction expenseTransaction) {
		this.tranDate=aTransaction.getBillDate();
		this.createdDate=new Date();
		this.invoiceNumber=aTransaction.getRefNo();
		...
		this.creditAmount=aTransaction.getTotalAmount();
	...
	public CreditCardAcct(ATransaction aTransaction, String categoryType,String detailType, ExpenseTransaction expenseTransaction) {
		this.tranDate=aTransaction.getBillDate();
		this.createdDate=new Date();
		this.invoiceNumber=aTransaction.getRefNo();
		this.accountName=aTransaction.getFromAccount();
	...
	public CreditCardAcct(String categoryType,String detailType, ATransaction atrans,ATransaction aTransaction, ExpenseTransaction expenseTransaction) {
		this.tranDate=aTransaction.getBillDate();
		this.createdDate=new Date();
		this.invoiceNumber=aTransaction.getRefNo();
		this.accountName=atrans.getToAccount();
	...
	public CreditCardAcct(AccountsDatabean accountsDatabean,List<ChartOfAccount> accDeposit) {

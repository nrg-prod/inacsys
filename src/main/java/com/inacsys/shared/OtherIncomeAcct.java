...
/**
 * The persistent class for the other_income_acct database table.
 * 
 */
@Entity
@Table(name="other_income_acct")
@NamedQuery(name="OtherIncomeAcct.findAll", query="SELECT o FROM OtherIncomeAcct o")
public class OtherIncomeAcct implements Serializable {
	...
	public OtherIncomeAcct() {
	}

	public OtherIncomeAcct(ATransaction atrans, ATransaction aTransaction,String categoryType,String detailType, ExpenseTransaction expenseTransaction) {
	...
	public OtherIncomeAcct(String categoryType,String detailType, ATransaction atrans,ATransaction aTransaction, ExpenseTransaction expenseTransaction) {
		this.tranDate=aTransaction.getBillDate();
		this.createdDate=new Date();
		this.invoiceNumber=aTransaction.getRefNo();
		this.accountName=atrans.getToAccount();

...
public class AccountsPayableLiablityMB {
	private static Logger logger = Logger
			.getLogger(AccountsPayableLiablityMB.class);
	...
	public String viewAccountPayable() {
		logger.info("[viewAccountPayable()] --------------- Inside viewAccountPayable() method() ------------------------");
		DemoController controller = null;
		try {
			flag = "none";
			flag1 = "none";
			purchaseOrder = new PurchaseOrder();
			logger.debug("[viewAccountPayable()] --------------- from date ------------------------>"+fromDate);
			logger.debug("[viewAccountPayable()] --------------- to date ------------------------>"+toDate);
